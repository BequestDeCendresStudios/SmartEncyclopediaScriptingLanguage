...
def competitive
  evaluate_malicious_users(0.754385965, 0.245614035, 0.16, 43)
  ...
  Saad::Competitive.starting_stats

  cycle = 0

  Saad::Competitive.evaluate_player
  Saad::Competitive.evaluate_gribatomaton
  Saad::Competitive.evaluate_enemy

  Saad::Competitive.mechanic_prediction
  ...
  size_limit.times do
    ...
    Saad::Competitive.increment_inputs
    
    #Saad::Competitive.show_gui
